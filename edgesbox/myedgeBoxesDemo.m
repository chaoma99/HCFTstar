...
%('Tiger0291.jpg');%('coke0164.jpg');%%%('lemming0373.jpg');%('singer2.jpg');%('couple.jpg');%('basketball1.jpg');
%('lemming0373.jpg');%('motorrolling0001.jpg');%('0066.jpg')%
...
% for ii=1:20
%     bb=bbs(ii,:);
%     rectangle('Position',[bb(1) bb(2) bb(3) bb(4)],'edgecolor','b');
% end
...
model.opts.multiscale=0; model.opts.sharpen=0; model.opts.nThreads=4;
  ...
  opts.maxBoxes =50;  % max number of boxes to detect 1e4
