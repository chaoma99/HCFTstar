function bbs = myedgeBoxes( I, model, varargin )
...
dfs={'name','', 'alpha',.65, 'beta',.75, 'eta',1, 'minScore',.01, ...
  ...
  'maxAspectRatio',3, 'minBoxArea',1000, 'gamma',2, 'kappa',1.5,'maxBoxArea',2000,'aspectRatio',1 };
...
f=o.name; 
if(~isempty(f) && exist(f,'file')), bbs=1; return; end
if(~iscell(I)),
...
model.opts.nms=0; [E,O]=edgesDetect(I,model);  %���ȱ�Ե���?if(0), E=gradientMag(convTri(single(I),4)); E=E/max(E(:)); end %���ȼ����ݶ�
E=edgesNmsMex(E,O,2,0,1,model.opts.nThreads); %Ȼ������Nms�Ա߽�������
bbs=myedgeBoxesMex(E,O,o.alpha,o.beta,o.eta,o.minScore,o.maxBoxes,... %����
  o.edgeMinMag,o.edgeMergeThr,o.clusterMinMag,...
  o.maxAspectRatio,o.minBoxArea,o.gamma,o.kappa,o.maxBoxArea,o.aspectRatio);
end
